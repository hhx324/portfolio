$(document).ready(function () {
  ...
  $(function() {
    var s1 = new slider($(".simple-slider_1"));
    s1.slideSlider(true);
    s1.slideToSlideIndex(3);

    var s2 = new slider($(".simple-slider_2"));
    s2.slideSlider(true);
    s2.slideToSlideIndex(3);
  });

  //mouseover시 일어나는 effect	
    var $infraEle = $("#cnt2 .cnt2_list li .cnt2_1_list");
